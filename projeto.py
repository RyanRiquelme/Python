...
# Logo
logo = tkinter.PhotoImage(file="Perry.png")
# Cria um label para exibir a imagem
label_imagem = ttk.Label(janela, image=logo, background="#E12222",)

# # # Tabela
# Cria a tabela com 3 colunas
tabela = ttk.Treeview(janela, columns=("Código", "Descrição", "Valor"), show="headings")
...
tabela.insert("", "end", text="1", values=("101", "X-Burguer", 12.00), tags=("par",))
tabela.insert("", "end", text="2", values=("102", "X-Egg", 14.50), tags=("impar",))
tabela.insert("", "end", text="3", values=("103", "X-Egg Bacon", 12.00), tags=("par",))
tabela.insert("", "end", text="4", values=("104", "X-Burguer", 12.00), tags=("impar",))
tabela.insert(
    "", "end", text="5", values=("201", "Coca Cola 2lts", 12.00), tags=("par",)
)
tabela.insert(
    "", "end", text="6", values=("202", "Guarana 2lts", 10.00), tags=("impar",)
)
tabela.insert(
    "", "end", text="7", values=("203", "Fanta Uva 2lts", 9.00), tags=("par",)
)
tabela.insert(
    "", "end", text="8", values=("301", "Pizza Grande", 40.00), tags=("impar",)
)
tabela.insert(
    "", "end", text="9", values=("302", "Pizza Super Grande", 55.00), tags=("par",)
)
tabela.insert(
    "", "end", text="9", values=("303", "Pizza Infinita", 70.00), tags=("impar",)
)
...
style.configure(
    "Treeview.Heading", font=fonte_cabecalho, background="red", foreground="black"
)
